...
namespace Api.V2.Controllers
{
    ...
    public class DownloadHistoryController : MainController
    {
        private readonly IDownloadHistoryApplicationService _applicationService;

        public DownloadHistoryController(IDownloadHistoryApplicationService applicationService)
        {
        ...
        [HttpPost("insert")]
        public async Task<IActionResult> Add([FromBody] DownloadHistoryViewModel viewModel)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromBody] DownloadHistoryViewModel viewModel)
        {
            var pageResult = new PageResult<DownloadHistoryViewModel>(viewModel);
            if (!ModelState.IsValid) return CustomResponse(pageResult);
